...
if __name__ == '__main__':
    ...
    from model.SF_faster_rcnn.resnet import resnet
    from model.SF_faster_rcnn.vgg16 import vgg16
    ...
    # iters_per_epoch = int(1000 / args.batch_size)
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        save_name = os.path.join(output_dir,
                                 'SF_source_{}_target_{}_gamma_{}_{}_{}_{}.pth'.format(args.ef,args.dataset_t,args.gamma,
                                                                                              args.session, epoch,
                                                                                              step))
        save_checkpoint({
