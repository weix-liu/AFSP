...
if __name__ == '__main__':
    ...
    from model.SF_faster_rcnn.resnet_mt import resnet
    from model.SF_faster_rcnn.vgg16_mt import vgg16
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            im_data_s.resize_(data_s.size()).copy_(data_s)  # (1,3,600,1200)
            ...
            (
                ...
                rois_label_s_fake
            ) = fasterRCNN(im_data_s, im_info, gt_boxes, num_boxes)


            loss = rpn_loss_cls_s_fake.mean() + rpn_loss_box_s_fake.mean() + RCNN_loss_cls_s_fake.mean() + RCNN_loss_bbox_s_fake.mean()
        ...
        save_name = os.path.join(output_dir,
                                 'SF_mt_target_{}_{}_{}_{}.pth'.format(args.dataset_t, args.session, epoch, step))
        save_checkpoint({
